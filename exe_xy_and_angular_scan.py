...
save_path = "C:\\Users\\Documents" # save path for the data files
note, File_name = "", "scan_plan" # optional user note and name of the final files 
...
save_path = "C:\\Users\\Documents" # save path for the data files
note, File_name = "", "scan_ang" # optional user note and name of the final files 
